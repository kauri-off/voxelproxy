...
Бесплатный аналог [takker.ru](https://takker.ru) — прокси для Minecraft, позволяющий двум клиентам одновременно играть на одном сервере под одним ником.

---

# [Сслыка на скачивание](https://github.com/kauri-off/voxelproxy/releases/latest)
