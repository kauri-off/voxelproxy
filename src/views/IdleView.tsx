                  ...
                  <div className="windivert-row">
                    ...
                    >
                      ...
                      <span
                        ...
                        title="Не отключайте это, если вы не программист. Перехват трафика (WinDivert) нужен, чтобы автоматически перенаправлять игру на дополнительные устройства. Отключать имеет смысл, только если вы умеете сами направлять трафик на втором устройстве другим способом — например, через рутованный телефон, который делает то же, что и WinDivert."
                      >
                        ?
                      </span>
                    </label>
